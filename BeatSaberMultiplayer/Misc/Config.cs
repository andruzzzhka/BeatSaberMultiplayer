...
namespace BeatSaberMultiplayer {
    ...
    public class Config {
        ...
        Config()
        {
            _serverHubIPs = new string[] { "127.0.0.1", "soupwhale.com", "hub.assistant.moe", "hub.n3s.co", "hub.auros.red", "beige.space", "treasurehunters.nz", "beatsaber.networkauditor.org", "hub.ligma.site", "hub.jogi-server.de", "freddi.xyz" };
